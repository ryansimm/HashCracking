...
# enumerate function adapted from code snippet on ' https://www.geeksforgeeks.org/python/python-convert-a-list-to-dictionary/ '
hash_dict = {i :value for i, value in enumerate(hashes)} 

# read and process the dictionary password file
...
for pword in pass_list:
    ...
    if hash_pass in hash_dict.values():
        cracked[hash_pass] = pword
